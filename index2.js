...
const files = [
  { file: 'naics_establishments.csv', description: 'Establishments count, per year.' },
  { file: 'two-digit-sector-01-17.csv', description: 'Two digit sector, per year.' },
  { file: 'three-digit-sub-sector-01-17.csv', description: 'Three digit sub-sector, per year.' },
...
But what are these keyframes? Data, derived from the source data!`
  ...
  main.variable(observer()).define(["md", "duration", "k"], function (md, duration, k) {
    return (
